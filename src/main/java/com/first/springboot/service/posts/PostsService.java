...
import com.first.springboot.web.dto.PostsListsResponseDto;
...
public class PostsService {
   ...
   public Long update(Long id, PostsUpdateRequestDto requestDto){
      ...
      System.out.println("getTitle : " + requestDto.getTitle());
      System.out.println("getContent : " + requestDto.getContent());
